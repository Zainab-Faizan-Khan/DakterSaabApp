      ...
      <>
        {/* ------------------BloodBank header-------------------------- */}
            ...
            <View style={styles.sortbtndiv}>
                ...
                <TouchableOpacity style={styles.sortbtns}  onPress={() => navigation.navigate('BloodDonar',{ email: email })}>
                    <Image style={styles.sortbtnimg}
